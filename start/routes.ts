...
Route.group(() => {
  Route.get("/get-by-id/:id", "FundsController.getFundsById").middleware(
    "auth:FONDOS_VISUALIZAR"
  );
  Route.post("/get-paginated", "FundsController.getFundsPaginated").middleware(
    "auth:FONDOS_CONSULTAR"
  );
  Route.post("/create", "FundsController.createFund").middleware(
    "auth:FONDOS_CREAR"
  );
...
Route.group(() => {
  ...
  Route.post("/create", "PagPagosController.processDocument").middleware(
    "auth:PAGOS_CONSULTAR"
  );
  Route.post(
    "/validate-rp",
    "PagPagosController.validarExistenciaRP"
  ).middleware("auth:PAGOS_CONSULTAR");
...
Route.group(() => {
  ...
  Route.post(
    ...
    "VinculationMGAController.getActivitiesDetail"
  );
  Route.post(
    "/create-vinculation-mga",
    "VinculationMGAController.createVinculationMga"
  );
...
Route.group(() => {
  Route.get(
    "/get-by-id/:id",
    "FunctionalAreaController.getFunctionalAreaById"
  ...
  Route.post(
    "/create",
    "FunctionalAreaController.createFunctionalArea"
  ).middleware("auth:AREA_FUNCIONAL_CREAR");
  Route.put(
    "/update/:id",
    "FunctionalAreaController.updateFunctionalArea"
  ).middleware("auth:AREA_FUNCIONAL_EDITAR");
...
Route.group(() => {
  Route.get(
    "/get-by-id/:id",
    "BudgetsRoutesController.getBudgetsRoutesById"
  ).middleware("auth:RUTA_PRESUPUESTAL_VISUALIZAR");
  Route.post(
    "/get-paginated",
  ...
  Route.post(
    "/get-paginatedV2",
    "BudgetsRoutesController.getBudgetsRoutesPaginatedV2"
  ).middleware("auth:RUTA_PRESUPUESTAL_CONSULTAR");
  Route.get(
    "/get-data",
  ...
  Route.post(
    "/create",
    "BudgetsRoutesController.createBudgetsRoutes"
  ).middleware("auth:RUTA_PRESUPUESTAL_CREAR");
  Route.put(
    "/update/:id",
...
Route.group(() => {
  Route.post(
    "/get-paginated",
    "AdditionsController.getAdditionsPaginated"
  ).middleware("auth:ADICION_CONSULTAR");
  ...
  Route.post(
    "/save-data",
    "AdditionsController.executeCreateAdditions"
  ).middleware("auth:ADICION_CREAR"); //Como acción de guardado
  Route.post("/create", "AdditionsController.createAdditions").middleware(
    "auth:ADICION_CREAR"
  ); //Como acción validación
  Route.get(
...
Route.group(() => {
  ...
  Route.post(
    "/save-data",
    "TransfersController.executeCreateTransfers"
  ).middleware("auth:TRASLADO_CREAR"); //Como acción de guardado
  Route.post("/create", "TransfersController.createTransfers").middleware(
    "auth:TRASLADO_CREAR"
  ); //Como acción validación
  Route.get(
    "/get-actadmin-district",
  ...
  ).middleware("auth:TRASLADO_EDITAR"); //Como acción de validación
  Route.post(
    "/update-save/:id",
...
Route.group(() => {
  ...
  Route.post(
    "/create",
    "FunctionalProjectsController.createFunctionalProject"
  ).middleware("auth:PROYECTO_FUNCIONAMIENTO_CREAR");
  Route.post(
    "/update-save/:id",
...
Route.group(() => {
  Route.post("/upload-pac", "PacsController.uploadPac").middleware(
    "auth:PAC_CARGAR"
  );
  Route.post("/review-budgetroute", "PacsController.reviewBudgetsRoute");
  Route.post("/transfers-pac", "PacsController.transfersOnPac").middleware(
    "auth:PAC_TRASLADO"
  );
  ...
  Route.post("/search-pacs", "PacsController.searchPacs").middleware(
    "auth:PAC_CONSULTAR"
  );
  ...
  Route.post(
    "/create-association",
    "PacsController.createAssociations"
  ).middleware("auth:PAC_ASOCIAR_RUTAS");
  Route.post("/edit-pac", "PacsController.editPac").middleware(
    "auth:PAC_EDITAR"
  );
  Route.get("/get-pac-by-id/:id", "PacsController.getPacById").middleware(
    "auth:PAC_VISUALIZAR"
  );
  Route.post("/get-view-pac", "PacsController.viewPacComplete").middleware(
    "auth:PAC_VISUALIZAR"
  );
})
  .prefix("/api/v1/pac")
...
Route.group(() => {
  ...
  Route.get(
    "/get-CDPRp-id/:id",
    "BudgetAvailabilityController.getRpCDP"
...
Route.group(() => {
  ...
  Route.post(
    "/get-rp-by-filters",
    "BudgetRecordsController.getRpByFilters"
  ).middleware("auth:RP_CONSULTAR");
  Route.get(
  ...
  Route.post("/update-data/:id", "BudgetRecordsController.updateRp").middleware(
    "auth:RP_RUTAS_EDITAR"
  );
...
Route.group(() => {
  ...
  ).middleware("auth:ACREEDOR_CREAR");
  Route.post(
    "update-creditor",
    "CreditorsController.updateCreditor"
  ).middleware("auth:ACREEDOR_EDITAR");
  Route.post(
