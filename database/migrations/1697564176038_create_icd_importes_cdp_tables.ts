...
export default class extends BaseSchema {
  ...
  public async up () {
    this.schema.createTable(this.tableName, (table) => {
      ...
      table.foreign('ICD_CODCDP').references('CDP_CODIGO').inTable('CDP_CERTIFICADO_DISPONIBILIDAD_PRESUPUESTAL')
      table.integer('ICD_CODRPP_RUTA_PRESUPUESTAL').unsigned().notNullable()
      table.foreign('ICD_CODRPP_RUTA_PRESUPUESTAL').references('RPP_CODIGO').inTable('RPP_RUTAS_PRESUPUESTALES')
