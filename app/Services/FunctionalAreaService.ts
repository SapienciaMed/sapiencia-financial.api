...
export interface IFunctionalAreaService {
  ...
  ): Promise<ApiResponse<IFunctionalArea>>;
  updateFunctionalArea(
    functionalArea: IFunctionalArea,
    id: number
  ): Promise<ApiResponse<IFunctionalArea | null>>;
  createProjectFunctionalArea(
    projectsVinculate: IProjectsVinculate
  ): Promise<ApiResponse<IProjectsVinculation[]>>;
  updateProjectFunctionalArea(
    projectsVinculate: IProjectsVinculate
  ): Promise<ApiResponse<IProjectsVinculation[] | null>>;
  deleteProjectFunctionalArea(
    projectVinculate: number
...
export default class FunctionalAreaService implements IFunctionalAreaService {
  ...
  async getFunctionalAreaPaginated(
    ...
    const res = await this.FunctionalAreaRepository.getFunctionalAreaPaginated(
      filters
    );
  ...
  async createFunctionalArea(
    ...
    const validNumber =
      await this.FunctionalAreaRepository.getFunctionalAreaByNumber(
    ...
    const res = await this.FunctionalAreaRepository.createFunctionalArea(
      functionalArea
    );
    return new ApiResponse(res, EResponseCodes.OK);
  }

  async updateFunctionalArea(
    functionalArea: IFunctionalArea,
    id: number
  ): Promise<ApiResponse<IFunctionalArea | null>> {
    const res = await this.FunctionalAreaRepository.updateFunctionalArea(
      functionalArea,
      id
    );
    if (!res) {
  ...
  async createProjectFunctionalArea(
    projectsVinculate: IProjectsVinculate
  ): Promise<ApiResponse<IProjectsVinculation[]>> {
    const res = await this.FunctionalAreaRepository.createProjectFunctionalArea(
      projectsVinculate
    );
    return new ApiResponse(res, EResponseCodes.OK);
  }

  async updateProjectFunctionalArea(
    projectsVinculate: IProjectsVinculate
  ): Promise<ApiResponse<IProjectsVinculation[] | null>> {
    const res = await this.FunctionalAreaRepository.updateProjectFunctionalArea(
      projectsVinculate
    );
    if (!res) {
      return new ApiResponse(
  ...
  async deleteProjectFunctionalArea(
    projectVinculate: number
  ): Promise<ApiResponse<boolean>> {
    const res = await this.FunctionalAreaRepository.deleteProjectFunctionalArea(
      projectVinculate
    );
    return new ApiResponse(res, EResponseCodes.OK);
  }
  ...
  async getProjectFunctionalAreaPaginated(
    ...
    const toSend = await tranformProjectsVinculation(res.array);
